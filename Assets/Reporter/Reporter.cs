...
public class Images
{
    ...
    public Texture2D    WholeBGImage;
    public Texture2D    GreyBGImage;
...
public class Reporter : MonoBehaviour {
	...
	void initializeStyle()
	{
		...
		backStyle.normal.background = images.WholeBGImage;
		backStyle.clipping = TextClipping.Clip ;
		backStyle.fontSize = (int)(size.y /2 );

        StackbackStyle = new GUIStyle();
        StackbackStyle.normal.background = images.GreyBGImage;
        StackbackStyle.clipping = TextClipping.Clip;
        StackbackStyle.fontSize = (int)(size.y / 2);
        ...
        evenLogStyle.fontSize = (int)(size.y / 2 * 1.5f);
        ...
        oddLogStyle.fontSize = (int)(size.y / 2 * 1.5f);
        ...
        selectedLogStyle.fontSize = (int)(size.y / 2 * 1.5f);
	...
	void drawStack(){
		...
		if( selectedLog != null)
		{
            ...
            GUILayout.BeginArea(stackRect, StackbackStyle);
